  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Badge
          variant='featured-artist'
          icon={<StarIcon color='#DCFD63' weight='regular' />}
        >
        ...
        <View style={styles.socials}>
          <Button
            ...
            icon={<InstagramLogoIcon color='#fff' />}
          />
          <Button
            variant='social-icons'
            icon={<MusicNoteIcon color='#fff' />}
          />
          <Button
            variant='social-icons'
            icon={<MusicNoteIcon color='#fff' />}
        ...
        <View style={styles.actions}>
          ...
          <Button
            title='Share'
            variant='share-follow'
            icon={<ShareNetworkIcon color='#fff' />}
            style={{ flex: 1 }}
          />
        </View>
      </View>
      ...
      <Badge variant='genre-profile' style={styles.genreBadge}>
        {artist.genre}
      </Badge>
      ...
      <Button
        title='Buy Token'
        variant='buy-token'
        icon={<CurrencyDollarIcon color='#000' />}
        style={{ width: "100%" }}
      />
    </LinearGradient>
  )
