...
export const VotingProgress: React.FC<VotingProgressProps> = ({ variant, value, max, votes }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <ProgressBar progress={progress} color={color} backgroundColor={backgroundColor} />
